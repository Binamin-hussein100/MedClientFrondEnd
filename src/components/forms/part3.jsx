...
const Part3 = ({ data, setData }) => {
    const [selectedSubject, setSelectedSubject] = useState(data.subject || subjects[0]);
    ...
    useEffect(() => {
        setData({ ...data, subject: selectedSubject, qualityLevel: selectedOption, format: selectedFormat, sources: value });
    }, [selectedSubject, selectedOption, selectedFormat, value]);
