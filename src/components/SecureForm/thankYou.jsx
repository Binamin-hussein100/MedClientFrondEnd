    ...
    return (
      <div className="flex flex-col justify-center items-center space-y-5 text-center mt-28">
        ...
        <p className="text-[#9699ab] text-[14px] w-96">
          Thank you! We hope you have fun using our
          platform. If you ever need support. Please feel free to email us at
          change@gmail.com
        </p>
        <Button
          className="mt-5 font-medium text-[#fff] bg-[#473dff] px-10 py-3 rounded-lg cursor-pointer transition duration-100 hover:opacity-90"
