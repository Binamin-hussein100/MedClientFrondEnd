          ...
          <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                ...
                {orders.map((order, i) => {
                    return (
                        <tr key={i} onClick={()=>navigate(`/order/${order.id}`)}>
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p className="text-gray-900 whitespace-no-wrap">{order.typeOfPaper}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p className="text-gray-900 whitespace-no-wrap">{order.deadline}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                              ...
                              <Button as={NavLi} to={`/order/${order.id}`}  color="primary" variant="flat">
                                    More Details
                              </Button>
                          </td>
                            </td>
